                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-9">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h1>글수정</h1>
                                            <form class="boardwrite" action="./post_modify.php" method="POST">
                                                <label>제목
                                                    <span class="color-red">*</span>
                                                </label>
                                                <input class="form-control margin-bottom-20" type="text" name="title" value="<?=morePost($_GET['idx'])->title?>">
                                                <label>작성자
                                                    <span class="color-red">*</span>
                                                </label>
                                                <input class="form-control margin-bottom-20" type="text" name="writer" value="<?=morePost($_GET['idx'])->writer?>">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <label>내용
                                                            <span class="color-red">*</span>
                                                        </label>
                                                        <textarea class="form-control margin-bottom-20" name="content"><?=morePost($_GET['idx'])->content?></textarea>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
