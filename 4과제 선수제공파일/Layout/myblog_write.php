                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-9">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h1>글쓰기</h1>
                                            <form class="boardwrite" action="./post_add.php" method="POST">
                                                <label>제목
                                                ...
                                                <input class="form-control margin-bottom-20" type="text" name="writer">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <label>내용
                                                            <span class="color-red">*</span>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 text-right">
                                                        <input type="hidden" name="idx" value="<?=$menu?>">
                                                        <input type="hidden" name="bidx" value="<?=$_GET['board']?>">
