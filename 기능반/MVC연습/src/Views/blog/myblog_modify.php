                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <form class="boardwrite" action="/blogModifyOk" method="POST">
                                                ...
                                                <input class="form-control margin-bottom-20" type="text" name="title" value="<?=$postData->title?>" required>
                                                <label>작성자
                                                    <span class="color-red">*</span>
                                                </label>
                                                <input class="form-control margin-bottom-20" type="text" value="<?=$postData->writer?>" disabled>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <label>내용
                                                            <span class="color-red">*</span>
                                                        </label>
                                                        <textarea class="form-control margin-bottom-20" required name="content"><?=$postData->content?></textarea>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
